...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        $stmt = $pdo->prepare("UPDATE listings SET title = ?, description = ?, price = ?, image_path = ? WHERE id = ?");
        $stmt->execute([$title, $description, $price, $image_path, $listing_id]);
...
<form method="POST" enctype="multipart/form-data">
    ...
    <div>
        ...
        <?php if ($listing['image_path']): ?>
            <p>Current image: <img src="<?php echo htmlspecialchars($listing['image_path']); ?>" alt="Current image" style="max-width: 100px;"></p>
        <?php endif; ?>
    </div>
